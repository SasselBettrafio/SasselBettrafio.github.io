...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Sassel")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Sassel %c 你正在访问Sassel's Home",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 𝓢𝓪𝓼𝓼𝓮𝓵") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('𝓢𝓪𝓼𝓼𝓮𝓵的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://s4.aconvert.com/convert/p3r68-cdx67/arq0w-6z37d.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      ...
      : `<img class='boardsign' src='https://s4.aconvert.com/convert/p3r68-cdx67/aigof-0xbih.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s2.loli.net/2023/04/22/HeRIvhO3l1gb7KV.jpg);
    --darkmode-bg:url(https://s2.loli.net/2023/04/22/lNZBRP6AxkYtbd9.jpg);
    --mobileday-bg: url(https://s2.loli.net/2023/04/23/Ueum8qHXGgTYAVw.jpg);
    --mobilenight-bg: url(https://s2.loli.net/2023/04/23/NznShL4J23QuA7y.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/22/HeRIvhO3l1gb7KV.jpg)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/22/HeRIvhO3l1gb7KV.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/22/lNZBRP6AxkYtbd9.jpg)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/22/lNZBRP6AxkYtbd9.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/22/aYsNOoe9IBrGgkL.jpg)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/22/aYsNOoe9IBrGgkL.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/22/2CGtuvoDwT7hExK.jpg)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/22/2CGtuvoDwT7hExK.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/23/sOBytvz7I5Glh6S.jpg)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/23/NznShL4J23QuA7y.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/23/Ueum8qHXGgTYAVw.jpg)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/23/Ueum8qHXGgTYAVw.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/24/gd7fkibTNnYAFz8.jpg)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/24/gd7fkibTNnYAFz8.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/25/zTKblBnYFMOWeR7.jpg)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/24/83ef4UOJjXREnsK.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/04/25/sF6luNUEOc3yt8T.jpg)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/04/25/sF6luNUEOc3yt8T.jpg)')"></a></div>
              </div>
            </details>
